...
export async function POST(request: NextRequest) {
  ...
  //    app/api/webhooks/paypesa/route.ts for the only code path allowed to
  //    do that.
  // ---------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------
  // 5. Hand off to the payment provider. See services/payments/PayPesaProvider.ts
  //    for exactly what is and isn't confirmed against PayPesa's real API yet.
  //
  ...
  //    webhook callback URL sent to PayPesa.
  // ---------------------------------------------------------------------
